...
class ContatosControllerTest < ActionController::TestCase
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post :create, contato: { acesso_id: @contato.acesso_id, email: @contato.email, mesage: @contato.mesage, nome: @contato.nome }
    end
  ...
  test "should update contato" do
    patch :update, id: @contato, contato: { acesso_id: @contato.acesso_id, email: @contato.email, mesage: @contato.mesage, nome: @contato.nome }
    assert_redirected_to contato_path(assigns(:contato))
  end
